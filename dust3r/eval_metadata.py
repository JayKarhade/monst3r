...
dataset_metadata = {
    ...
    'sintel': {
        'img_path': "/ocean/projects/cis220039p/mdt2/jkarhade/Any4D/benchmarking/monst3r/data/sintel/training/final",
        'anno_path': "/ocean/projects/cis220039p/mdt2/jkarhade/Any4D/benchmarking/monst3r/data/sintel/training/camdata_left",
        'mask_path': None,
        'dir_path_func': lambda img_path, seq: os.path.join(img_path, seq),
        'gt_traj_func': lambda img_path, anno_path, seq: os.path.join(anno_path, seq),
        'traj_format': None,
        # 'seq_list': ["shaman_3"],
        # 'seq_list': ["sleeping_1", "sleeping_2", "temple_2", "temple_3"],
